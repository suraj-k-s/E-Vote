...
export default class Electionagentassignlist extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      columns: [
        ...
        {
          field: "district_name",
          headerName: "Assiged District",
          flex: 1,
        },
        {
          field: "sectionpart_name",
          headerName: "Assiged Sectionpart",
          flex: 1,
        },
        {
          field: "place_name",
          headerName: "Assiged place",
          flex: 1,
        },
        {
          field: "ward_name",
          headerName: "Assiged Ward",
          flex: 1,
        },
        {
  ...
  componentDidMount() {
    axios
      .get(
        "http://localhost/e-vote/api/Electionagentassignlist.php"
      )
